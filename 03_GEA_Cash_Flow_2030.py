...
for i in gea_region_codes:
    ...
    ePrice_df_folder = os.path.join(inputFolder, 'Cambium22_Mid-case_2030', 'input')
    # ePrice_df_folder = os.path.join(inputFolder, 'Cambium22_Electrification_2030', 'input')
    ...
    ePrice_df_t5 = ePrice_df_t5['total_cost_enduse'] + PTC_wind
    ePrice_df_t6 = ePrice_df_t6['total_cost_enduse'] + PTC_wind
    ePrice_df_t7 = ePrice_df_t7['total_cost_enduse'] + PTC_wind # Phaseout
    ePrice_df_t8 = ePrice_df_t8['total_cost_enduse'] + PTC_wind # Phaseout
    ...
    ePrice_2050_54_df = pd.concat([ePrice_df_t8, ePrice_df_t8, ePrice_df_t8, ePrice_df_t8, ePrice_df_t8], axis = 1, ignore_index = True)

    # Concatenate
    ePrice_df = pd.concat([ePrice_2030_34_df, ePrice_2035_39_df, ePrice_2040_44_df, ePrice_2045_49_df, ePrice_2050_54_df], axis = 1, ignore_index = True)
    ...
    # folder = os.path.join(inputFolder, 'Cambium22_Mid-case_2030', 'Cash_Flow')
    folder = os.path.join(inputFolder, 'Cambium22_Mid-case_2030', 'Cash_Flow_PTC_No_Phaseout')
    # folder = os.path.join(inputFolder, 'Cambium22_Electrification_2030', 'Cash_Flow')
    # folder = os.path.join(inputFolder, 'Cambium22_Electrification_2030', 'Cash_Flow_PTC_No_Phaseout')
