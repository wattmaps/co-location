...
# Read USWTDB
wind_proj <- read_csv(here::here('data', 'uswtdb', 'uswtdb_v4_3_20220114_ucsb.csv'))

# Add spatial coordinates
wind_proj_geom <- st_as_sf(wind_proj, coords = c('xlong', 'ylat'), crs = 4269)
...
# Save df to csv
write.csv(pid_coords, here::here('data', 'uswtdb', 'us_PID_cords.csv'), row.names = FALSE)
